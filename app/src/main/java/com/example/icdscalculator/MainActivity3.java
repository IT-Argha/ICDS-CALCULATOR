    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float EgSev = (float) (Sev * 0);
                float EgGen = (float) ( Gen * 0);
                ...
                float vegPw= (float) (PowL * 1.63);
                float vgeSever = (float) (Sev * 1.09);
                float vgeGn = (float) ( Gen * 1.09);
                ...
                int GenMngSls = (Gen * 1);
                int SevereMngSls =( Sev * 1 );
                GenMngSlsk.setText(String.valueOf(GenMngSls));
                SevereMngSlsk.setText(String.valueOf(SevereMngSls));

                float CtatuSugGenCos = (float) (GenMngSls * 3.25);
                float ChatuSugSevereCos = (float) ( SevereMngSls * 3.25);
